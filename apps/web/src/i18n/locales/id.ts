...
export const id: Dict = {
  ...
  'settings.testSuccessApi': 'Terhubung. Membalas dalam {ms} ms - \'{sample}\'',
  'settings.testSuccessCli': '{agentName} membalas dalam {ms} ms - \'{sample}\'',
  'settings.testAuthFailed': 'Autentikasi gagal. Periksa API key.',
  'settings.testForbidden': 'Akses ditolak. Periksa akun, region, atau organisasi.',
  ...
  'settings.testTimeout': 'Tes melewati batas waktu setelah {ms} ms.',
  'settings.testAgentMissing': '{agentName} belum terpasang atau tidak ada di PATH.',
  'settings.testAgentSpawn': 'Tidak dapat menjalankan {agentName}: {detail}.',
